...
import cn.chenzecheng.ruoyi.framework.tech.test.config.RedisTestConfiguration;
...
public class BaseRedisUnitTest {
    ...
    @Import({
            // Redis 配置类
            RedisTestConfiguration.class, // Redis 测试配置类，用于启动 RedisSMyver
            RedisAutoConfiguration.class, // Spring Redis 自动配置类
            MyRedisAutoConfiguration.class, // 自己的 Redis 配置类
